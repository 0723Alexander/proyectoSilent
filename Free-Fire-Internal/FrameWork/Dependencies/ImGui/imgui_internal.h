...
enum ImGuiItemStatusFlags_
{
    ...
    ImGuiItemStatusFlags_FocusedByTabbing = 1 << 11,
...
enum ImGuiNavHighlightFlags_
{
    ...
    ImGuiNavHighlightFlags_TypeThin = 1 << 2,
    ImGuiNavHighlightFlags_AlwaysDraw       = 1 << 3,       // Draw rectangular highlight if (g.NavId == id) _even_ when using the mouse.
    ImGuiNavHighlightFlags_NoRounding       = 1 << 4,
...
//#endif
    ...
    bool ItemHoverable2(const ImRect& bb, ImGuiID id);
    ...
    bool IsMouseClicked2(ImGuiMouseButton button, bool repeat);
    bool IsMouseClickede(ImGuiMouseButton button, ImGuiID owner_id, ImGuiInputFlags flags);
